...
<head>
		...
		<meta name="description" content="This is a personal portfolio template to showcase my skillset and my love for Product Management" />
		<meta name="keywords" content="product management, personal portfolio, CV, Experience" />
...
function validateContact() {
    	...
    	<div class="container wrapper">
            ...
            <div class="text-me">
              ...
              <ul class="list-inline actions">
                ...
                <li><a href = "Cover Letter.pdf" target="_blank" ><button class="btn btn-primary"> Get Cover Letter </button></a></li>
              </ul>
            </div>
          </div>
    		</div>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <table style="width:100%">
              ...
              <tr>
                <td><img src="/media/designer/sap.png" alt="SAP" style="width:60px;height:60px;"></td>
                <td><img src="/media/designer/Salesforce.png" alt="Salesforce" style="width:60px;height:60px;"></td>
                <td><img src="/media/designer/JIRA.png" alt="JIRA" style="width:60px;height:60px;"></td>
                <td><img src="/media/designer/SQL.png" alt="SQL" style="width:60px;height:60px;"></td>
                <td><img src="/media/designer/amazon web services.png" alt="amazon web services" style="width:60px;height:60px;"></td>
              </tr>
              <tr>
                <td><img src="/media/designer/Microsoft SharePoint.png" alt="Microsoft SharePoint" style="width:60px;height:60px;"></td>
                <td><img src="/media/designer/confluence.png" alt="confluence" style="width:60px;height:60px;"></td>
                <td><img src="/media/designer/github.png" alt="github" style="width:60px;height:60px;"></td>
                <td><img src="/media/designer/Sketch.png" alt="Sketch" style="width:60px;height:60px;"></td>
                <td><img src="/media/designer/Postman.png" alt="Postman" style="width:60px;height:60px;"></td>
                
              </tr>
              <tr>
                <td><img src="/media/designer/HTML5.png" alt="html" style="width:60px;height:60px;"></td>
                <td><img src="/media/designer/css.png" alt="css3" style="width:60px;height:60px;"></td>
                <td><img src="/media/designer/Javascript.png" alt="Javascript" style="width:60px;height:60px;"></td>
                <td><img src="/media/designer/Microsoft Office.png" alt="Microsoft Office" style="width:60px;height:60px;"></td>
                <td><img src="/media/designer/tableau.png" alt="tableau" style="width:60px;height:60px;"></td>
              </tr>
            </table>
            ...
            <div class="col-md-4 col-md-offset-1">
              <div class="photo-skills">
                <img src="media/designer/skills 2.png" alt="" class="img-responsive img-skills"  />
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="col-md-2 scale-anm1">
      <a href="https://open.spotify.com/show/7KYWblZSh3A1rv9vPKk5mF" target="_blank">
      <img src="/media/designer/spotify.png" alt="Product Management Podcast"> 
     </a>
    <div>
      <a href="https://open.spotify.com/show/7KYWblZSh3A1rv9vPKk5mF" > <p style="color: #000000;"> My Podcast</p></a>
    </div>
  </div>

  <div class="col-md-2 scale-anm1">
      <a href="https://www.youtube.com/channel/UCzMIwQCvank9xCqHMoPA80A?view_as=subscriber" target="_blank">
      <img src="/media/designer/social/youtube.png" alt="Product Management Youtube Channel" >
      </a>
      <div>
      <a href="https://www.youtube.com/channel/UCzMIwQCvank9xCqHMoPA80A?view_as=subscriber" > <p style="color: #000000;"> My Youtube Channel</p></a>
    </div>
  </div>

  <div class="col-md-2 scale-anm1">
      <a href="https://medium.com/product-management-a-practical-approach" target="_blank">
        <img src="/media/designer/medium.png" alt="Product Management Blog" >
      </a>
      <div>
      <a href="https://medium.com/product-management-a-practical-approach" > <p style="color: #000000;"> My Blog</p></a>
    </div>
  </div>
      
  <div class="col-md-2 scale-anm1">
      <a href="https://github.com/pathakakanksha991" target="_blank">
        <img src="/media/designer/github.png" alt="Product Management Projects" >
      </a> 
      <div>
      <a href="https://github.com/pathakakanksha991" > <p style="color: #000000;"> My GitHub Profile</p></a>
    </div> 
  </div>

  <div class="col-md-2 scale-anm1">
    <a href="https://www.linkedin.com/in/akankshapathak1991/" target="_blank">                  
     <img src="/media/designer/social/linkedin.png" alt="linkedin profile" >
     </a>
     <div>
      <a href="https://www.linkedin.com/in/akankshapathak1991/" > <p style="color: #000000;"> My LinkedIn Profile</p></a>
    </div>
  </div>
          <!--  <table id="t01">
            ...
            <div class="contact-info">
              <div class="contact-detail">
                ...
                <div class="reach">
                  ...
                  <p>contact@akankshapathak.com</p>
